...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("first_instance", "http://ec2-52-23-154-207.compute-1.amazonaws.com");
		instances[1] = new DataCenterInstance("second_instance", "http://ec2-54-174-16-249.compute-1.amazonaws.com");
		instances[2] = new DataCenterInstance("third_instance", "http://ec2-54-164-115-63.compute-1.amazonaws.com");
	}
